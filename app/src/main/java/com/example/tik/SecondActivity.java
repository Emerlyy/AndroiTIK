...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str013.setSpan(new SubscriptSpan(),1,3, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        ...
        str014.setSpan(new SubscriptSpan(),1,3, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
